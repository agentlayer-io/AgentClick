...
Mina`,
      ...
      replyDraft: {
        ...
        paragraphs: [
          {
            id: 'rp1',
            content: 'Thanks, I reviewed the note and the timing works for me.',
          },
          {
            id: 'rp2',
            content: 'Please send the final changelog before the external version goes out, and I will do one last pass today.',
          },
        ],
        intentSuggestions: [
          { id: 'reply_intent_1', text: 'Confirm the rollout timing' },
          { id: 'reply_intent_2', text: 'Request final changelog before send' },
          { id: 'reply_intent_3', text: 'Keep tone warm and concise' },
        ],
      },
      category: 'Primary',
